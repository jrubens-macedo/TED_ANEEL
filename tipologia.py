...
nome_arquivo = r'C:\pythonjr\tipologia\dados.csv'
...
try:
    ...
    plt.text(0.126, 0.86, f'Máx kW (DU) = {max_kW_DU:.2f} kW', transform=plt.gcf().transFigure,
    ...
    # Adiciona o valor de max_kW_DU no gráfico
    plt.text(0.448, 0.86, f'Máx kW (SA) = {max_kW_SA:.2f} kW', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold')
    ...
    plt.text(0.772, 0.86, f'Máx kW (DO) = {max_kW_DO:.2f} kW', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
    ...
    with pd.ExcelWriter(r'C:\pythonjr\tipologia\Output.xlsx') as writer:
    ...
    with open(r'C:\pythonjr\tipologia\loadshapes_UGMT.dss', 'w') as arquivo_dss:
        arquivo_dss.write(
