...
# Use a formatação de string para incluir a variável no caminho do arquivo
...
try:
    ...
    with open(nome_arquivo, 'r', newline='', encoding='utf-8') as arquivo_csv:
        ...
        for linha in leitor_csv:
            ...
            primeiro_dia = datetime(data_hora.year, 1, 1, 1)
            ultimo_dia = datetime(data_hora.year, 12, 1, 1)
...
# Filtra os registros associados a dias úteis
    ...
    plt.text(0.183, 0.84, f'(ANUAL) UGMT = {mes_ugmt}', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold', fontsize=12)
    ...
    plt.ylim(0, 1.2)
    plt.xticks(range(0, 25, 4), fontsize=14)
    ...
    plt.text(0.51, 0.88, f'Máx. kW (SA) = {max_kW_SA:.2f} kW', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold', fontsize=12)
    plt.text(0.51, 0.84, f'(ANUAL) UGMT = {mes_ugmt}', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold', fontsize=12)
    ...
    plt.text(0.828, 0.88, f'Máx. kW (DO) = {max_kW_DO:.2f} kW', transform=plt.gcf().transFigure,
             ...
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold', fontsize=12)
    plt.text(0.828, 0.84, f'(ANUAL) UGMT = {mes_ugmt}', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold', fontsize=12)
    ...
    caminho_figura = fr'C:\pythonjr\tedaneel\UGMT_{cod_ugmt}\DSS_Figuras\UGMT_{cod_ugmt}_ANUAL.png'
    ...
    with open(fr'C:\pythonjr\tedaneel\UGMT_{cod_ugmt}\DSS_Loadshapes\UGMT_{cod_ugmt}_ANUAL.dss', 'w') as arquivo_dss:
