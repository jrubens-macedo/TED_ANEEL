...
try:
    ...
    ultima_data_hora = datetime.strptime(ultima_linha[0], '%d/%m/%Y %H:%M')
    ultima_kw = float(ultima_linha[1])
...
# Filtra os registros associados a dias úteis
    ...
    # Adiciona o valor de max_kW_DU no gráfico
    plt.text(0.515, 0.88, f'Máx. kW (SA) = {max_kW_SA:.2f} kW', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold', fontsize=12)
    plt.text(0.515, 0.84, f'(ANUAL) UGMT = {mes_ugmt}', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold', fontsize=12)
    ...
    plt.text(0.84, 0.88, f'Máx. kW (DO) = {max_kW_DO:.2f} kW', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             #bbox=dict(facecolor='white', edgecolor='white'))
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold', fontsize=12)
    plt.text(0.84, 0.84, f'(ANUAL) UGMT = {mes_ugmt}', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold', fontsize=12)
