...
nome_arquivo = (r'C:\pythonjr\tipologia\UGMT_16458559\JAN-16458559.csv')
...
try:
    ...
    plt.text(0.183, 0.84, f'Mês-UGMT = {mes_ugmt}', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold')
    ...
    plt.text(0.514, 0.88, f'Máx kW (SA) = {max_kW_SA:.2f} kW', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold')
    plt.text(0.514, 0.84, f'Mês-UGMT = {mes_ugmt}', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold')
    ...
    plt.text(0.8434, 0.88, f'Máx kW (DO) = {max_kW_DO:.2f} kW', transform=plt.gcf().transFigure,
             ...
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold')
    plt.text(0.8434, 0.84, f'Mês-UGMT = {mes_ugmt}', transform=plt.gcf().transFigure,
             horizontalalignment='center', verticalalignment='center',
             bbox=dict(facecolor='white', edgecolor='white'), fontweight='bold')
